        ...
        activmap : function(settings){
            ...
            _init = function(){
                ...
                $.each(s.places, function(i, place){
                    ...
                    mycontent += '<div class="activmap-details"><h4 class="activmap-title"><a href="'+place.url+'" target="_blank">'+place.title+'</a></h4>';
                    ...
                    if(place.url != undefined && place.url != '') mycontent += `<a onClick='logEvent("click","MapLink", "${place.url}");' href="${place.url}" target="_blank" class="activmap-url">Learn More</a>`;
                    ...
                    place.html = '<div class="activmap-place" id="activmap-place_'+i+'"><h3>'+place.title+'</h3><p>'+place.address+'</p><p>'+place.custom+'</p></div>';
            ...
            _update_places_tag = function(input, uncheck){
                ...
                $('#activmap-results-num').html(num_places+' locations(s) near you');
            }
